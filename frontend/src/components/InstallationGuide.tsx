...
export default function InstallationGuide({ installScripts }) {
  return (
    <section>
      <h2 className="text-2xl font-semibold mb-3 text-[#2C3E50]">インストール方法</h2>
      <div className="space-y-6">
        {Object.entries(installScripts).map(([os, script]) => (
          <div key={os} className="bg-gray-50 rounded-lg shadow-sm overflow-hidden">
            <div className="bg-gray-100 px-4 py-2 flex justify-between items-center">
              ...
              <ScriptCopyButton script={script} scriptType={`${os}-install`} />
            </div>
